    ...
    return (
      <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="intro" className={`${this.props.article === 'intro' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>Debaters need to be effective communicators; Impact Debate focuses on this necessity every day during camp. Each day of camp includes multiple speaking exercises that are aimed at building confidence and fluency amongst students. As we source instructors from each region of the country, PFA is unique in its commitment to building debaters who can communicate effectively to any type of audience. After two weeks with us, students not only win more debate rounds, but also participate more actively in school discussions and become community leaders. </p>
